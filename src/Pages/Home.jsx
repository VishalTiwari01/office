...
import Patner from "../assets/PartnerImage.png";
...
const Home = () => {
  return (
    <div className="bg-blue-50  flex flex-col items-center  px-4">
      ...
      <div className=" w-full max-w-6xl  rounded-xl shadow-md p-6 md:p-8 flex flex-col md:flex-col items-center justify-between gap-6 bg-[#0e7490]">
